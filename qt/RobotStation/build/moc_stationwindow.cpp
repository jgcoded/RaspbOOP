...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StationWindow_t, stringdata) + ofs \
...
const QMetaObject StationWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_StationWindow.data,
      qt_meta_data_StationWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StationWindow.stringdata))
        return static_cast<void*>(const_cast< StationWindow*>(this));
